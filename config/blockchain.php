...
return [
	/**
	* Blockchain guid provided by blockchain.com
	*/
	'blockchain_guid' => env('BLOCKCHAIN_GUID'),
	/**
	* Blockchain password provided by blockchain.com
	*/
	'blockchain_password' => env('BLOCKCHAIN_PASSWORD'),
